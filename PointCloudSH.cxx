...
int main(){
    ...
    t = clock() - t;
    std::cout<< "Time for GLQ = " << ((float)t)/CLOCKS_PER_SEC << std::endl;
    ...
    t = clock() - t;
    std::cout<< "Time for DH = " << ((float)t)/CLOCKS_PER_SEC << std::endl;
    ...
    t = clock() - t;
    std::cout<< "Time for LSQ = " << ((float)t)/CLOCKS_PER_SEC << std::endl;
